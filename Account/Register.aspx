        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-lg-8">
                    <asp:TextBox ID="txtRPassword" runat="server" class="form-control" Type="password" MaxLength="50" required />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-lg-4">First name</label>
                <div class="col-lg-8">
                    <asp:TextBox ID="txtFN" runat="server" class="form-control" MaxLength="100" required />
                </div>
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-lg-offset-4 col-lg-8">
                    <recaptcha:RecaptchaControl ID="rcRegister" runat="server" 
                        PublicKey="6LcnviATAAAAAIiKMRDISZbrCAkrgeHmN_fqnKGd"
                         PrivateKey="6LcnviATAAAAABaxDEMgeuk8OJP8-CWuDlyw1jr6" 
                        Theme="clean"/>
                </div>
            </div>
            <div class="form-group">
