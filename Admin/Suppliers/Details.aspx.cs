...
public partial class Admin_Suppliers_Details : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else //user selected a record 
        {
            ...
            bool validSupplier = int.TryParse(Request.QueryString["ID"].ToString(), out supplierID); // to check if id is valid 
    ...
    void GetData(int ID)
    {
        ...
        {
            string SQL = @"SELECT SupplierID, CompanyName, ContactPerson, Address, Phone, Mobile, Status 
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(Util.GetConnection()))
        {
            string SQL = @"INSERT INTO Suppliers VALUES (@CompanyName, @ContactPerson, @Address, @Phone, @Mobile,
